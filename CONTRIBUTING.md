...
To execute integration tests, the following components must be installed via **Visual Studio Installer** (either as **individual components** or as part of **Desktop development with C++** workload):
