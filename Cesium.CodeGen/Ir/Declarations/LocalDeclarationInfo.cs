    ...
    string? CliImportMemberName)
{
        ...
        ref int i)
    {
        ...
        return typeNames switch
            {
                ["signed", "long", "long", "int"] => new PrimitiveType(PrimitiveTypeKind.SignedLongLongInt),
                ["unsigned", "long", "long", "int"] => new PrimitiveType(PrimitiveTypeKind.UnsignedLongLongInt),
                ["signed", "short", "int"] => new PrimitiveType(PrimitiveTypeKind.SignedShortInt),
                ["signed", "long", "int"] => new PrimitiveType(PrimitiveTypeKind.SignedLongInt),
                ["signed", "long", "long"] => new PrimitiveType(PrimitiveTypeKind.SignedLongLong),
                ["long", "long", "int"] => new PrimitiveType(PrimitiveTypeKind.LongLongInt),
                ["unsigned", "short", "int"] => new PrimitiveType(PrimitiveTypeKind.UnsignedShortInt),
                ["unsigned", "long", "int"] => new PrimitiveType(PrimitiveTypeKind.UnsignedLongInt),
                ["unsigned", "long", "long"] => new PrimitiveType(PrimitiveTypeKind.UnsignedLongLong),
                ["signed", "char"] => new PrimitiveType(PrimitiveTypeKind.SignedChar),
                ["signed", "short"] => new PrimitiveType(PrimitiveTypeKind.SignedShort),
                ["short", "int"] => new PrimitiveType(PrimitiveTypeKind.ShortInt),
                ["signed", "int"] => new PrimitiveType(PrimitiveTypeKind.SignedInt),
                ["signed", "long"] => new PrimitiveType(PrimitiveTypeKind.SignedLong),
                ["long", "int"] => new PrimitiveType(PrimitiveTypeKind.LongInt),
                ["long", "long"] => new PrimitiveType(PrimitiveTypeKind.LongLong),
                ["long", "double"] => new PrimitiveType(PrimitiveTypeKind.LongDouble),
                ["unsigned", "char"] => new PrimitiveType(PrimitiveTypeKind.UnsignedChar),
                ["unsigned", "short"] => new PrimitiveType(PrimitiveTypeKind.UnsignedShort),
                ["unsigned", "int"] => new PrimitiveType(PrimitiveTypeKind.UnsignedInt),
                ["unsigned", "long"] => new PrimitiveType(PrimitiveTypeKind.UnsignedLong),
                ["void"] => new PrimitiveType(PrimitiveTypeKind.Void),
                ["char"] => new PrimitiveType(PrimitiveTypeKind.Char),
                ["short"] => new PrimitiveType(PrimitiveTypeKind.Short),
                ["signed"] => new PrimitiveType(PrimitiveTypeKind.Signed),
                ["int"] => new PrimitiveType(PrimitiveTypeKind.Int),
                ["unsigned"] => new PrimitiveType(PrimitiveTypeKind.Unsigned),
                ["long"] => new PrimitiveType(PrimitiveTypeKind.Long),
                ["float"] => new PrimitiveType(PrimitiveTypeKind.Float),
                ["double"] => new PrimitiveType(PrimitiveTypeKind.Double),
                ["__nint"] => new PrimitiveType(PrimitiveTypeKind.NativeInt),
                ["__nuint"] => new PrimitiveType(PrimitiveTypeKind.NativeUInt),
