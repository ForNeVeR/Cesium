...
int main(void)
{
    ...
    const char* p = "10 200000000000000000000000000000 -200000000000000000000000000000 30 -40 junk";
    printf("Parsing '%s':\n", p);
    ...
    for (;;)
    {
        ...
        if (i == LONG_MAX)
        {
            printf("Extracted '%.*s', strtol returned LONG_MAX.", (int)(end - p), p);
        }
        else if (i == LONG_MIN)
        {
            printf("Extracted '%.*s', strtol returned LONG_MIN.", (int)(end - p), p);
        }
        else
        {
