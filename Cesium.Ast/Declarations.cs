...
// 6.7 Declarations
public sealed record Declaration(ImmutableArray<IDeclarationSpecifier> Specifiers, ImmutableArray<InitDeclarator>? InitDeclarators);
...
public sealed record StructOrUnionSpecifier(ComplexTypeKind TypeKind, string? Identifier, ImmutableArray<StructDeclaration> StructDeclarations);
public sealed record EnumSpecifier(string? Identifier, ImmutableArray<EnumDeclaration>? StructDeclarations);
...
public sealed record IdentifierDirectDeclarator(string Identifier) : IDirectDeclarator
{
    public IDirectDeclarator? Base => null;
}
public sealed record ArrayDirectDeclarator(IDirectDeclarator Base, ImmutableArray<TypeQualifier>? TypeQualifiers, Expression? Size);
public sealed record ParameterListDirectDeclarator(IDirectDeclarator Base, ParameterTypeList Parameters);
public sealed record IdentifierListDirectDeclarator(IDirectDeclarator Base, ImmutableArray<string>? Identifiers);
